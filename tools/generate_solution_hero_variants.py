...
source_png = root / 'solutions-hero.png'

if not source_png.exists():
    print('Source solutions-hero.png not found at', source_png)
    raise SystemExit(1)
...
for w in sizes:
    ...
    webp_path = root / f'solutions-hero-{w}.webp'
    png_path = root / f'solutions-hero-{w}.png'
